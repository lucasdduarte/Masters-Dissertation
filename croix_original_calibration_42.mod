...
theta = 5/6;            % price-elasticity of demand for a differentiated good
...
phi0= 0.622232992199611;   %effort function scale parameter for N=0.95 and e=1 (comes from finding w_ss and using this in consumer optimal effort) -----> when inflation changes, dont forget to update this
phi1= 0.943737795436668;   %effort function scale parameter for N=0.95 and e=1 (comes from finding w_ss and using this in firm optimal effort)-----> when inflation changes, dont forget to update this
