...
phi0= 0.616342435990086;   %effort function scale parameter for N=0.95 and e=1 (comes from finding w_ss and using this in consumer optimal effort) -----> when inflation changes, dont forget to update this
phi1= 0.929307210575967;   %effort function scale parameter for N=0.95 and e=1 (comes from finding w_ss and using this in firm optimal effort)-----> when inflation changes, dont forget to update this
